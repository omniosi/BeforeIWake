!function(t, i) {
    "use strict";
    var s, e = i.event;
    e.special.smartresize = {setup: function() {
        ...
        this.element = i(s), this._create(t), this._init()
    }, i.Mason.settings = {isResizable: !0,isAnimated: !1,animationOptions: {queue: !1,duration: 500},gutterWidth: 0,isRTL: !1,isFitWidth: !1,containerStyle: {position: "relative"}}, i.Mason.prototype = {_filterFindBricks: function(t) {
            var i = this.options.itemSelector;
            return i ? t.filter(i).add(t.find(i)) : t
        },_getBricks: function(t) {
            var i = this._filterFindBricks(t).css({position: "absolute"}).addClass("masonry-brick");
            return i
        },_create: function(s) {
            ...
            var h = this.element.css("padding-" + this.horizontalDirection), a = this.element.css("padding-top");
            this.offset = {x: h ? parseInt(h, 10) : 0,y: a ? parseInt(a, 10) : 0}, this.isFluid = this.options.columnWidth && "function" == typeof this.options.columnWidth;
            var r = this;
            setTimeout(function() {
            ...
            var t = this.options.isFitWidth ? this.element.parent() : this.element, i = t.width();
            ...
            d[this.horizontalDirection] = this.columnWidth * l + this.offset.x, this.styleQueue.push({$el: a,style: d});
            var m = r + a.outerHeight(!0), p = this.cols + 1 - u;
            for (c = 0; p > c; c++)
                this.colYs[l + c] = m
        },resize: function() {
            var t = this.cols;
        ...
        var n = this, o = n.find("img").add(n.filter("img")), h = o.length, a = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==", r = [];
...
!function(t, i) {
    var s = {init: function() {
            ...
            if (Optica.$body.hasClass("iframe") || Optica.$body.hasClass("touch"))
                i.css({opacity: 1}).addClass("loaded");
            else {
                var s = i.data("bg-image"), e = new Image;
            ...
            var t = Optica.Utils.hex_to_hsv(Optica.ACCENT_COLOR), i = Optica.Utils.hex_to_hsv(Optica.BACKGROUND_COLOR);
            ...
            if (i.length) {
                ...
                i.css({color: "rgba(" + s.r + "," + s.g + "," + s.b + ", 0.7)"})
            }
        },devices: function() {
            ...
            var i = "itms-apps://itunes.com/apps/tumblr/tumblr", s = document.getElementById("app_protocol_check") || document.createElement("iFrame");
            ...
            var s, e, o, n = parseInt(t, 16), a = 0 > i ? 0 : 255, r = 0 > i ? -i : i, h = n >> 16, c = n >> 8 & 255, l = 255 & n;
    ...
    n.prototype = {__mouse_enter: function(i) {
        ...
        }}, n.defaults = {forgiveness_delay: 0}, t.fn.drawer = function(t) {
        return this.each(function() {
            new n(this, t)
        })
    };
    var a = function(i, s) {
        this.$el = t(i), this.options = t.extend({animate_opacity: !1,animate_position: !0,inertia: .3,opacity_inertia: .4}, s || {}), this.inertia = this.options.inertia, Optica.$win.on("Eventor:scroll", t.proxy(this.__window_scroll, this))
    };
    a.prototype = {__window_scroll: function() {
            this.parallax()
        },reset_offset: function() {
            this.$el.css({transform: "translate3d(0, 0, 0)"})
        },parallax: function() {
            var t = Optica.$win.scrollTop(), i = Math.round(t * this.inertia);
            if (!(i > 400)) {
                if (this.options.animate_opacity) {
                    var s = t * this.options.opacity_inertia, e = (100 - s) / 100;
                    0 > e && (e = 0), this.$el.css({opacity: e})
                }
                this.options.animate_position && this.$el.css({transform: "translate3d(0," + i + "px, 0)"})
            }
        }};
    var r = function(i, s, e) {
        return this instanceof r ? (this.el = "string" == typeof i ? t(i).get(0) : i, this.$el = t(i), this.config = t.extend({}, r.defaults, s), this.callback = e || function() {
        }, this.successes = 0, this.errors = 0, this.items = [], this.get_items(), this) : new r(i, s, e)
    };
    r.prototype = {get_items: function() {
        ...
        }}, r.defaults = {selector: "iframe"}, t.fn.iframesLoaded = function(t, i) {
        return this.each(function() {
            new r(this, t, i)
        })
    };
    var h = function(i, s) {
        return this instanceof h ? (this.el = "string" == typeof i ? t(i).get(0) : i, this.$el = t(i), this.options = s, this.metadata = this.$el.data("plugin-options"), this.config = t.extend({}, h.defaults, this.options, this.metadata), this.trigger = this.config.trigger, this.$trigger = this.$el.find(this.trigger), this.$search_input = t("#search input"), this.events = {trigger_click: t.proxy(this.__trigger_click, this),document_click: t.proxy(this.__document_click, this),glass_click: t.proxy(this.__class_click, this),offset_scroll: t.proxy(this._check_offset, this)}, this.bind_events(), h.register(this), this) : new h(i, s)
    };
    h.prototype = {__document_click: function(i) {
            var s = t(i.target);
            ...
            var s = this.$el.find(this.config.popover), e = this.$el.find(this.config.trigger);
        ...
        }}, h.instances = [], h.defaults = {container: ".pop",trigger: ".selector",popover: ".pop-menu",use_glass: !1,glass: ".glass",scroll_distance: 50}, h.register = function(t) {
    ...
    var c = {__window_scroll: function() {
            ...
            Optica.LOADING_NOTES = !1, this.events = {scroll: t.proxy(this.__window_scroll, this)}, this.bind_events()
        },bind_events: function() {
    ...
    l.prototype = {__document_keydown: function(i) {
            var s = i.charCode ? i.charCode : i.keyCode, e = i ? i.target : window.event.srcElement;
            t(e).is("input:focus") || this.is_grid_layout || (74 === s ? this.next_post() : 75 === s ? this.previous_post() : 190 === s && Optica.$win_body.animate({scrollTop: 0}))
            ...
            var e, o;
            return function() {
                var n = s || this, a = +new Date, r = arguments;
            ...
            var s = i.offset().top, e = i.outerHeight(), o = s + e;
            return t.data(i[0], "offsets", {top: s,height: e,bottom: o})
        },_in_view: function(t) {
            ...
            this.show_loader();
            var i = t.ajax({url: this.base_url + this.next_page_number,dataType: "html"});
            i.done(t.proxy(this._append_new_posts, this)), i.fail(t.proxy(this._failed, this))
        },_failed: function() {
            this.hide_loader(!0)
        },_append_new_posts: function(i) {
            var s = t(i).find("#posts > div"), e = s.children(), o = [];
            e.each(t.proxy(function(i, s) {
                ...
                s.iframesLoaded({selector: ".post-content iframe"}, t.proxy(function() {
                    this.config.$target.masonry("appended", e, !0), this.loading_data = !1, this.animate_posts(e), this.hide_loader()
                }, this))
            }, this)) : (this.loading_data = !1, this.update_spotify(s), Optica.$body.hasClass("narrow") && this.upscale_images(s), e.fadeTo(300, 1), this.hide_loader()), Tumblr.LikeButton.get_status_by_post_ids(o), window.ga && ga("send", "pageview", {page: "/page/" + this.next_page_number,title: "Index Page -- Ajax Load"}), this.current_page = this.next_page_number, this.next_page_number++
        },cache_selectors: function() {
            this.$html = t("html"), this.$header = t("#header"), this.$posts = t("#posts")
        },animate: function() {
            if (this.go_to_position && !this.animating) {
                this.animating = !0;
                t("html,body").stop().animate({scrollTop: this.go_to_position - 10}, 250, t.proxy(function() {
                    this.animating = !1
                }, this))
            }
        },set_masonry: function() {
            var i = t("#posts"), s = i.find("article");
            i.imagesLoaded(t.proxy(function() {
                i.iframesLoaded({selector: ".post-content iframe"}, t.proxy(function() {
                    i.masonry({itemSelector: "article",isFitWidth: !0}), this.animate_posts(s)
                }, this))
            ...
            this._slender() ? (Optica.$body.addClass("slender").removeClass("grid"), Optica.GRID_LAYOUT && this.is_grid_layout && (this.config.$target.css({width: "auto"}), this.config.$target.masonry("destroy"), this.is_grid_layout = !1)) : (Optica.$body.removeClass("slender"), Optica.GRID_LAYOUT && Optica.$body.hasClass("index-page") && (Optica.$body.addClass("grid"), this.set_masonry()))
            ...
            var s = t(".audio_container").width(), e = s + 80, o = i && i.length ? t(".spotify_audio_player", i) : t(".spotify_audio_player");
            o.each(s > 500 ? function() {
                t(this).css({width: s,height: e}), t(this).attr("src", t(this).attr("src"))
            } : function() {
                t(this).css({width: s,height: 80}), t(this).attr("src", t(this).attr("src"))
            })
            ...
            var s = ".twitter-tweet, .tumblr-embed, .tumblr_audio_player, .spotify_audio_player", e = "iframe:not(" + s + "), object, embed", o = i && i.length ? t(e, i) : t(e, "#page");
            o.each(function() {
                var i = t(this);
                if (i.data("aspect-ratio"))
                    i.css({height: i.width() * i.data("aspect-ratio") + "px"});
                else {
                    var s = i.attr("height") || i.height(), e = i.attr("width") || i.width(), o = s / e;
                    i.data("aspect-ratio", o), i.is(".photoset") ? i.width(i.parent().width()) : i.css({width: "100%"}), i.css({height: i.width() * o + "px"})
                }
            })
        },next_page: function() {
        ...
        }}, l.instances = [], l.defaults = {bufferPx: 1e3,$pagination: t("#pagination"),$loader: t(".loader"),resizeDelay: 100,scrollDelay: 100,$target: t("#posts")}, l.register = function(t) {
        this.instances.push(t)
    ...
    var t = $("body");
    t.hasClass("contain-header-image") ? new Optica.Parallaxer("body:not(.ie10, .touch) .parallax", {animate_opacity: !0,animate_position: !1}) : new Optica.Parallaxer("body:not(.ie10, .touch) .parallax"), new Optica.Pager(window, {$pagination: $("#pagination a"),$loader: $("#pagination .loader"),endless_scrolling: Optica.ENDLESS_SCROLLING}), $("body:not(.touch) #posts").drawer({trigger: "article:not(.exposed)"}), $("#page").popmenu(), t.hasClass("permalink") && $(".more_notes_link").length && Optica.ENDLESS_NOTES_SCROLLING && Optica.NotesPager.init()
});
